...
pub fn evaluate_termo_3(pair: Pair<Rule>, scope: &mut Scope) -> Value {
...
mod tests {
    ...
    fn parse_and_evaluate_termo_3(input: &str) -> Value {
        ...
        evaluate_termo_3(pair, &mut scope)
    }
